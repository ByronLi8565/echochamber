...
import { consumeDrag } from "../actions/drag.ts";
...
import {
  normalizeSoundboardFilters,
  getAudioContext,
  getReverbImpulse,
  reverseBuffer,
  clamp,
} from "../../util/audio-utils.ts";
...
export function createSoundboard(
  ...
  function onHotkeyCapture(e: KeyboardEvent) {
    ...
    const usedHotkeys = new Set(Array.from(hotkeyRegistry.keys()));
